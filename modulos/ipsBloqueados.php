<script>
    $(document).ready(function () {
        mostraDados('regras/bloqueados/ips_bloqueados.txt', 'ipsBloqueados');
...
<?php
$arquivo = "regras/bloqueados/ips_bloqueados.txt";
$erro = "";
...
<ol class="breadcrumb">
    ...
    <li class="active">Ips Bloqueados</li>
</ol>
<div class="jumbotron">
    <form action="index.php?modulos=ipsBloqueados" id="formulario_usuario" method="POST" class="form-horizontal" role="form">
